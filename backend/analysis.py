...
async def get_analysis(account_id: int, gacha_type: Optional[str] = None, session: Session = Depends(get_session)):
    """获取抽卡分析报告"""
...
async def get_all_statistics(session: Session = Depends(get_session)):
    """获取所有账号的统计对比"""
